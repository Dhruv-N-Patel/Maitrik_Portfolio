...
class Certification(models.Model):
    ...
    description = models.TextField()
    image = models.ImageField(upload_to ='portfolio_app/static/', default = "portfolio_app/static/default-image.jpg")
...
class WorkExperience(models.Model):
    ...
    mentor_position = models.CharField(max_length=100)
    image = models.ImageField(upload_to='images/', default = "portfolio_app/static/default-image.jpg")
    description = models.TextField()
    type = models.CharField(max_length=20, choices=type, default='misc')
...
class ContactForm(models.Model):
    ...
    phone_number = models.CharField(max_length=10)  # Adjust the max_length as per your requirements
